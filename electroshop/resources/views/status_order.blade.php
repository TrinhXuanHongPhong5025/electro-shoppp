...
<html lang="en">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="{{asset('css/statusorder.css')}}"/>
                                        ...
                                        <div class="col-md-15">
                                          <div class="well">
                                            <table class="table caption-top">
                                                <caption>Tình trạng đơn hàng</caption>
                                                <thead>
                                                  <tr>
                                                    <th scope="col">STT</th>
                                                    ...
                                                    <th scope="col">Tổng giá của sản phẩm </th>
                                                  </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td></td>
                                                        <td>{{$order_detail->order_total}} VND</td>
                                                    </tr>
                                                </tbody>
                                            </table>

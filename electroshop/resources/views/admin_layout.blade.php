...
<link href="{{asset('backend/css/font-awesome.backend/css')}}" rel="stylesheet">
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                    <a href="#"><!--<a href="fontawesome.html">-->
...
<!-- ckeditor -->
<script src="{{asset('backend/ckeditor_v4/ckeditor/ckeditor.js')}}"></script>
<script>
	CKEDITOR.replace('ckeditor_v4');

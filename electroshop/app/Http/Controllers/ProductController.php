...
class ProductController extends Controller
{
    ...
    public function update_product(Request $request, $product_id){ //$product_id: Đây là tham số đầu vào của hàm. Trong quá trình gọi hàm, bạn sẽ cung cấp giá trị cho $product_id. Ví dụ, nếu bạn gọi hàm như sau update_product(123), thì $product_id sẽ mang giá trị 123 trong phạm vi của hàm.(sẽ lấy cái id đó để xóa or sửa theo mục đích cá nhân)
        $this->AuthenLogin();
        $date = array();
        $date['product_name'] = $request->product_name;
        $date['product_status'] = $request->product_status;
